 ...
 */
        ...
        import com.example.matti.lippuvaraaja.SlidingTabLayout;
...
/**
 * A basic sample which shows how to use {@link com.example.matti.lippuvaraaja.SlidingTabLayout}
 * to display a custom {@link ViewPager} title strip which gives continuous feedback to the user
 * when scrolling.
 */
public class SlidingTabsColorFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabs.add(new SamplePagerItem(
                getString(R.string.tab_teatteri), // Title
                Color.BLUE, // Indicator color
                Color.GRAY // Divider color
        ));

        mTabs.add(new SamplePagerItem(
                getString(R.string.tab_elokuvat), // Title
                Color.RED, // Indicator color
                Color.GRAY // Divider color
        ));

        mTabs.add(new SamplePagerItem(
                getString(R.string.tab_paiva), // Title
                Color.YELLOW, // Indicator color
                Color.GRAY // Divider color
        ));

        mTabs.add(new SamplePagerItem(
                getString(R.string.tab_naytos), // Title
